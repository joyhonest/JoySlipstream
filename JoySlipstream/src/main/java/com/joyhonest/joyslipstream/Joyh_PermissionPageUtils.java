...
//            设置标记将Activity放到一个新的Task中
    ...
    private void doStartApplicationWithPackageName(String packagename) {
        ...
        // 通过getPackageManager()的queryIntentActivities方法遍历，返回给定条件的所有ResolveInfo对象
