...
public class Joyh_PermissionAsker {

    private Runnable mOkRun = RUN;
    private Runnable mDeniRun = RUN;
    private int mReqCode = 1;

    public Joyh_PermissionAsker() {
    }

    public Joyh_PermissionAsker(int code, Runnable ok, Runnable deni) {
        this.mReqCode = code;
        this.mOkRun = ok;
        this.mDeniRun = deni;
    }
    ...
    public Joyh_PermissionAsker askPermission(Activity context, String... permission) {
        int result = 0;
